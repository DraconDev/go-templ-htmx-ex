...
func NavigationLoggedIn(user UserInfo) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<nav class=\"glass-nav overflow-x-hidden\"><div class=\"max-w-7xl mx-auto px-4 sm:px-6\"><div class=\"flex justify-between items-center h-16\"><div class=\"flex items-center flex-shrink-0\"><a href=\"/\" class=\"text-sm sm:text-lg font-semibold text-white hover:text-cyan-400 transition-colors duration-200\">🚀 Startup Platform</a></div><div class=\"flex items-center space-x-3 sm:space-x-4\"><a href=\"/payment\" class=\"text-sm sm:text-base text-white hover:text-cyan-400 transition-colors duration-200 font-medium whitespace-nowrap\">Pricing</a><div class=\"relative\"><button onclick=\"toggleProfileDropdown()\" class=\"flex items-center justify-center w-8 h-8 sm:w-11 sm:h-11 rounded-full overflow-hidden hover:scale-105 transition-transform duration-200\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func NavigationLoggedOut() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<nav class=\"glass-nav overflow-x-hidden\"><div class=\"max-w-7xl mx-auto px-4 sm:px-6\"><div class=\"flex justify-between items-center h-16\"><div class=\"flex items-center flex-shrink-0\"><a href=\"/\" class=\"text-sm sm:text-lg font-semibold text-white hover:text-cyan-400 transition-colors duration-200\">🚀 Startup Platform</a></div><div class=\"flex items-center space-x-3 sm:space-x-4\"><a href=\"/payment\" class=\"text-sm sm:text-base text-white hover:text-cyan-400 transition-colors duration-200 font-medium whitespace-nowrap\">Pricing</a> <a href=\"/login\" class=\"bg-red-600 hover:bg-red-500 text-white px-3 py-2 sm:px-5 sm:py-2.5 rounded-lg text-sm sm:text-base font-semibold transition-all duration-200 whitespace-nowrap\">Login</a></div></div></div></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
